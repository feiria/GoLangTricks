...
const (
	defaultConfigFilePath = "/src/ioc_and_di/"
...
func (*_viper) InitViper(env string) {
	...
	viper.AddConfigPath(pwd + defaultConfigFilePath)
	viper.SetConfigFile(pwd + defaultConfigFilePath + filename + "." + defaultConfigFileType)
